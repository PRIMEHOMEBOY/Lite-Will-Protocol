...
export default function App() {
  ...
  return(
    <>
      <Background/>
      {noContract&&<div style={{position:"fixed",top:0,left:0,right:0,zIndex:50,background:"rgba(245,158,11,.12)",borderBottom:"1px solid rgba(245,158,11,.4)",padding:"10px 20px",textAlign:"center",fontFamily:"'Share Tech Mono',monospace",fontSize:11,letterSpacing:".15em",color:"#fcd34d"}}>⚠ CONTRACT NOT CONFIGURED — add VITE_CONTRACT_ADDRESS to your .env</div>}
